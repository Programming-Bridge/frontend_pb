        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
          {filteredTech.map((item) => {
            ...
            return (
              <div
                key={tId}
                className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-border border-l-[4px] border-l-brand bg-card p-4 transition-all hover:border-l-brand-hover hover:border-brand/40 hover:shadow-lg"
              >
                <div>
